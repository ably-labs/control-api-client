...
module SwaggerClient
  class QueueResponse
    ...
    attr_accessor :deadletter

    # The ID of the dead letter queue.
    attr_accessor :deadletter_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::QueueResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::QueueResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'stomp')
        self.stomp = attributes[:'stomp']
      end
      ...
      if attributes.key?(:'deadletter')
        self.deadletter = attributes[:'deadletter']
      end

      if attributes.key?(:'deadletter_id')
        self.deadletter_id = attributes[:'deadletter_id']
      end
    end
    ...
    def hash
      [id, app_id, name, region, amqp, stomp, state, messages, stats, ttl, max_length, deadletter, deadletter_id].hash
    end

...
module SwaggerClient
  class QueueResponseStats
    ...
    attr_accessor :acknowledgement_rate
    ...
    def self.openapi_types
      {
        :'publish_rate' => :'Object',
        :'delivery_rate' => :'Object',
        :'acknowledgement_rate' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::QueueResponseStats` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::QueueResponseStats`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'publish_rate')
        self.publish_rate = attributes[:'publish_rate']
      end
      ...
      if attributes.key?(:'acknowledgement_rate')
        self.acknowledgement_rate = attributes[:'acknowledgement_rate']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          publish_rate == o.publish_rate &&
          delivery_rate == o.delivery_rate &&
          acknowledgement_rate == o.acknowledgement_rate
    end
    ...
    def hash
      [publish_rate, delivery_rate, acknowledgement_rate].hash
    end

...
module SwaggerClient
  class AzureFunctionRulePostTarget
    ...
    attr_accessor :azure_app_id

    # The name of your Microsoft Azure Function.
    attr_accessor :azure_function_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::AzureFunctionRulePostTarget` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::AzureFunctionRulePostTarget`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'azure_app_id')
        self.azure_app_id = attributes[:'azure_app_id']
      end

      if attributes.key?(:'azure_function_name')
        self.azure_function_name = attributes[:'azure_function_name']
      end
    ...
    def list_invalid_properties
      ...
      if @azure_app_id.nil?
        invalid_properties.push('invalid value for "azure_app_id", azure_app_id cannot be nil.')
      end

      if @azure_function_name.nil?
        invalid_properties.push('invalid value for "azure_function_name", azure_function_name cannot be nil.')
      end
    ...
    def valid?
      return false if @azure_app_id.nil?
      return false if @azure_function_name.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          azure_app_id == o.azure_app_id &&
          azure_function_name == o.azure_function_name &&
          headers == o.headers &&
    ...
    def hash
      [azure_app_id, azure_function_name, headers, signing_key_id, enveloped, format].hash
    end

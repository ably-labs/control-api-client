  ...
  class AwsAssumeRole
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::AwsAssumeRole` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::AwsAssumeRole`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @assume_role_arn.nil?
        invalid_properties.push('invalid value for "assume_role_arn", assume_role_arn cannot be nil.')
      end
    ...
    def valid?
      authentication_mode_validator = EnumAttributeValidator.new('Object', ['assumeRole'])
      return false unless authentication_mode_validator.valid?(@authentication_mode)
      return false if @assume_role_arn.nil?
      true
    end
    ...
    def authentication_mode=(authentication_mode)
      validator = EnumAttributeValidator.new('Object', ['assumeRole'])
    ...
    def hash
      [authentication_mode, assume_role_arn].hash
    end

...
# Unit tests for SwaggerClient::RuleSource
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RuleSource' do
  before do
    # run before each test
    @instance = SwaggerClient::RuleSource.new
  end
  ...
  describe 'test an instance of RuleSource' do
    it 'should create an instance of RuleSource' do
      expect(@instance).to be_instance_of(SwaggerClient::RuleSource)
    end
  end

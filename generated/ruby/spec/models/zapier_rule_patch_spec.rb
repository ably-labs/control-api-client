...
# Unit tests for SwaggerClient::ZapierRulePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZapierRulePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::ZapierRulePatch.new
  end
  ...
  describe 'test an instance of ZapierRulePatch' do
    it 'should create an instance of ZapierRulePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::ZapierRulePatch)
    end
  end

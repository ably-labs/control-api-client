...
# Unit tests for SwaggerClient::HttpRulePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HttpRulePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::HttpRulePatch.new
  end
  ...
  describe 'test an instance of HttpRulePatch' do
    it 'should create an instance of HttpRulePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::HttpRulePatch)
    end
  end

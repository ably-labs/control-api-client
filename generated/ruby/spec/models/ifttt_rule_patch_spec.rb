...
# Unit tests for SwaggerClient::IftttRulePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IftttRulePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::IftttRulePatch.new
  end
  ...
  describe 'test an instance of IftttRulePatch' do
    it 'should create an instance of IftttRulePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::IftttRulePatch)
    end
  end

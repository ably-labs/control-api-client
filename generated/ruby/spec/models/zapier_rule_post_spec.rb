...
# Unit tests for SwaggerClient::ZapierRulePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZapierRulePost' do
  before do
    # run before each test
    @instance = SwaggerClient::ZapierRulePost.new
  end
  ...
  describe 'test an instance of ZapierRulePost' do
    it 'should create an instance of ZapierRulePost' do
      expect(@instance).to be_instance_of(SwaggerClient::ZapierRulePost)
    end
  end

...
# Unit tests for SwaggerClient::AwsKinesisRulePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsKinesisRulePost' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsKinesisRulePost.new
  end
  ...
  describe 'test an instance of AwsKinesisRulePost' do
    it 'should create an instance of AwsKinesisRulePost' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsKinesisRulePost)
    end
  end

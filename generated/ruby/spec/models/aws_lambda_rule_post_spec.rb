...
# Unit tests for SwaggerClient::AwsLambdaRulePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsLambdaRulePost' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsLambdaRulePost.new
  end
  ...
  describe 'test an instance of AwsLambdaRulePost' do
    it 'should create an instance of AwsLambdaRulePost' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsLambdaRulePost)
    end
  end

...
# Unit tests for SwaggerClient::RulePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RulePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::RulePatch.new
  end
  ...
  describe 'test an instance of RulePatch' do
    it 'should create an instance of RulePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::RulePatch)
    end
  end
end

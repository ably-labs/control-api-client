...
# Unit tests for SwaggerClient::AmqpExternalRuleResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmqpExternalRuleResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::AmqpExternalRuleResponse.new
  end
  ...
  describe 'test an instance of AmqpExternalRuleResponse' do
    it 'should create an instance of AmqpExternalRuleResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::AmqpExternalRuleResponse)
    end
  end
  ...
  describe 'test attribute "rule_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["amqp/external"])

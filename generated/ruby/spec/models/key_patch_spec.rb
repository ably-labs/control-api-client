...
# Unit tests for SwaggerClient::KeyPatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KeyPatch' do
  before do
    # run before each test
    @instance = SwaggerClient::KeyPatch.new
  end
  ...
  describe 'test an instance of KeyPatch' do
    it 'should create an instance of KeyPatch' do
      expect(@instance).to be_instance_of(SwaggerClient::KeyPatch)
    end
  end

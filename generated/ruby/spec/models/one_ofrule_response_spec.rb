...
# Unit tests for SwaggerClient::OneOfruleResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OneOfruleResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::OneOfruleResponse.new
  end
  ...
  describe 'test an instance of OneOfruleResponse' do
    it 'should create an instance of OneOfruleResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::OneOfruleResponse)
    end
  end
end

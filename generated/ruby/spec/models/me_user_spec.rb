...
# Unit tests for SwaggerClient::MeUser
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MeUser' do
  before do
    # run before each test
    @instance = SwaggerClient::MeUser.new
  end
  ...
  describe 'test an instance of MeUser' do
    it 'should create an instance of MeUser' do
      expect(@instance).to be_instance_of(SwaggerClient::MeUser)
    end
  end

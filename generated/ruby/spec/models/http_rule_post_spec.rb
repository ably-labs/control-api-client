...
# Unit tests for SwaggerClient::HttpRulePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HttpRulePost' do
  before do
    # run before each test
    @instance = SwaggerClient::HttpRulePost.new
  end
  ...
  describe 'test an instance of HttpRulePost' do
    it 'should create an instance of HttpRulePost' do
      expect(@instance).to be_instance_of(SwaggerClient::HttpRulePost)
    end
  end

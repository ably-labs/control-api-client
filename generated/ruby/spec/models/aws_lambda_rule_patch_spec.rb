...
# Unit tests for SwaggerClient::AwsLambdaRulePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsLambdaRulePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsLambdaRulePatch.new
  end
  ...
  describe 'test an instance of AwsLambdaRulePatch' do
    it 'should create an instance of AwsLambdaRulePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsLambdaRulePatch)
    end
  end

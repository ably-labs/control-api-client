...
# Unit tests for SwaggerClient::GoogleCloudFunctionRuleResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GoogleCloudFunctionRuleResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::GoogleCloudFunctionRuleResponse.new
  end
  ...
  describe 'test an instance of GoogleCloudFunctionRuleResponse' do
    it 'should create an instance of GoogleCloudFunctionRuleResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::GoogleCloudFunctionRuleResponse)
    end
  end
  ...
  describe 'test attribute "rule_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["http/google-cloud-function"])

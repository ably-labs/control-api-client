...
# Unit tests for SwaggerClient::AwsSqsRuleResponseTarget
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsSqsRuleResponseTarget' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsSqsRuleResponseTarget.new
  end
  ...
  describe 'test an instance of AwsSqsRuleResponseTarget' do
    it 'should create an instance of AwsSqsRuleResponseTarget' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsSqsRuleResponseTarget)
    end
  end

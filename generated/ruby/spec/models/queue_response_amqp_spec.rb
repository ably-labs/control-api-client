...
# Unit tests for SwaggerClient::QueueResponseAmqp
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueueResponseAmqp' do
  before do
    # run before each test
    @instance = SwaggerClient::QueueResponseAmqp.new
  end
  ...
  describe 'test an instance of QueueResponseAmqp' do
    it 'should create an instance of QueueResponseAmqp' do
      expect(@instance).to be_instance_of(SwaggerClient::QueueResponseAmqp)
    end
  end

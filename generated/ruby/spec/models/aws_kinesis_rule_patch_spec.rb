...
# Unit tests for SwaggerClient::AwsKinesisRulePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsKinesisRulePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsKinesisRulePatch.new
  end
  ...
  describe 'test an instance of AwsKinesisRulePatch' do
    it 'should create an instance of AwsKinesisRulePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsKinesisRulePatch)
    end
  end

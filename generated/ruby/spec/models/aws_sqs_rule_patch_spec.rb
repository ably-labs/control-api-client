...
# Unit tests for SwaggerClient::AwsSqsRulePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsSqsRulePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsSqsRulePatch.new
  end
  ...
  describe 'test an instance of AwsSqsRulePatch' do
    it 'should create an instance of AwsSqsRulePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsSqsRulePatch)
    end
  end

...
# Unit tests for SwaggerClient::ZapierRuleResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ZapierRuleResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::ZapierRuleResponse.new
  end
  ...
  describe 'test an instance of ZapierRuleResponse' do
    it 'should create an instance of ZapierRuleResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::ZapierRuleResponse)
    end
  end
  ...
  describe 'test attribute "rule_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["http/zapier"])

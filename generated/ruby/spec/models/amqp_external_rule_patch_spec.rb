...
# Unit tests for SwaggerClient::AmqpExternalRulePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmqpExternalRulePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::AmqpExternalRulePatch.new
  end
  ...
  describe 'test an instance of AmqpExternalRulePatch' do
    it 'should create an instance of AmqpExternalRulePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::AmqpExternalRulePatch)
    end
  end

...
# Unit tests for SwaggerClient::AwsKinesisRulePostTarget
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsKinesisRulePostTarget' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsKinesisRulePostTarget.new
  end
  ...
  describe 'test an instance of AwsKinesisRulePostTarget' do
    it 'should create an instance of AwsKinesisRulePostTarget' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsKinesisRulePostTarget)
    end
  end

...
# Unit tests for SwaggerClient::QueueResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueueResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::QueueResponse.new
  end
  ...
  describe 'test an instance of QueueResponse' do
    it 'should create an instance of QueueResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::QueueResponse)
    end
  end
  ...
  describe 'test attribute "stomp"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "deadletter"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "deadletter_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

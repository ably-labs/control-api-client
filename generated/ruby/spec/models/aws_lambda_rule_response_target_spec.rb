...
# Unit tests for SwaggerClient::AwsLambdaRuleResponseTarget
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsLambdaRuleResponseTarget' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsLambdaRuleResponseTarget.new
  end
  ...
  describe 'test an instance of AwsLambdaRuleResponseTarget' do
    it 'should create an instance of AwsLambdaRuleResponseTarget' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsLambdaRuleResponseTarget)
    end
  end

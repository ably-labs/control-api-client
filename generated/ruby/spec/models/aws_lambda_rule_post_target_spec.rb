...
# Unit tests for SwaggerClient::AwsLambdaRulePostTarget
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsLambdaRulePostTarget' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsLambdaRulePostTarget.new
  end
  ...
  describe 'test an instance of AwsLambdaRulePostTarget' do
    it 'should create an instance of AwsLambdaRulePostTarget' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsLambdaRulePostTarget)
    end
  end

...
# Unit tests for SwaggerClient::HttpRulePatchTarget
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HttpRulePatchTarget' do
  before do
    # run before each test
    @instance = SwaggerClient::HttpRulePatchTarget.new
  end
  ...
  describe 'test an instance of HttpRulePatchTarget' do
    it 'should create an instance of HttpRulePatchTarget' do
      expect(@instance).to be_instance_of(SwaggerClient::HttpRulePatchTarget)
    end
  end

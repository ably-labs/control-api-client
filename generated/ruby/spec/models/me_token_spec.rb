...
# Unit tests for SwaggerClient::MeToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MeToken' do
  before do
    # run before each test
    @instance = SwaggerClient::MeToken.new
  end
  ...
  describe 'test an instance of MeToken' do
    it 'should create an instance of MeToken' do
      expect(@instance).to be_instance_of(SwaggerClient::MeToken)
    end
  end

...
# Unit tests for SwaggerClient::AzureFunctionRulePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AzureFunctionRulePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::AzureFunctionRulePatch.new
  end
  ...
  describe 'test an instance of AzureFunctionRulePatch' do
    it 'should create an instance of AzureFunctionRulePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::AzureFunctionRulePatch)
    end
  end

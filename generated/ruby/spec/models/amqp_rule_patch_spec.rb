...
# Unit tests for SwaggerClient::AmqpRulePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmqpRulePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::AmqpRulePatch.new
  end
  ...
  describe 'test an instance of AmqpRulePatch' do
    it 'should create an instance of AmqpRulePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::AmqpRulePatch)
    end
  end

...
# Unit tests for SwaggerClient::QueueResponseStomp
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'QueueResponseStomp' do
  before do
    # run before each test
    @instance = SwaggerClient::QueueResponseStomp.new
  end
  ...
  describe 'test an instance of QueueResponseStomp' do
    it 'should create an instance of QueueResponseStomp' do
      expect(@instance).to be_instance_of(SwaggerClient::QueueResponseStomp)
    end
  end

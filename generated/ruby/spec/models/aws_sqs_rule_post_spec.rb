...
# Unit tests for SwaggerClient::AwsSqsRulePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsSqsRulePost' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsSqsRulePost.new
  end
  ...
  describe 'test an instance of AwsSqsRulePost' do
    it 'should create an instance of AwsSqsRulePost' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsSqsRulePost)
    end
  end

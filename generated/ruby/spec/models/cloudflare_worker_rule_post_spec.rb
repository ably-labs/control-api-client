...
# Unit tests for SwaggerClient::CloudflareWorkerRulePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CloudflareWorkerRulePost' do
  before do
    # run before each test
    @instance = SwaggerClient::CloudflareWorkerRulePost.new
  end
  ...
  describe 'test an instance of CloudflareWorkerRulePost' do
    it 'should create an instance of CloudflareWorkerRulePost' do
      expect(@instance).to be_instance_of(SwaggerClient::CloudflareWorkerRulePost)
    end
  end

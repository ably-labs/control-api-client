...
# Unit tests for SwaggerClient::AwsKinesisRuleResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsKinesisRuleResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsKinesisRuleResponse.new
  end
  ...
  describe 'test an instance of AwsKinesisRuleResponse' do
    it 'should create an instance of AwsKinesisRuleResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsKinesisRuleResponse)
    end
  end
  ...
  describe 'test attribute "rule_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["aws/kinesis"])

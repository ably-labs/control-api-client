...
# Unit tests for SwaggerClient::OneOfrulePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OneOfrulePost' do
  before do
    # run before each test
    @instance = SwaggerClient::OneOfrulePost.new
  end
  ...
  describe 'test an instance of OneOfrulePost' do
    it 'should create an instance of OneOfrulePost' do
      expect(@instance).to be_instance_of(SwaggerClient::OneOfrulePost)
    end
  end
end

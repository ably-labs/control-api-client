...
# Unit tests for SwaggerClient::OneOfrulePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OneOfrulePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::OneOfrulePatch.new
  end
  ...
  describe 'test an instance of OneOfrulePatch' do
    it 'should create an instance of OneOfrulePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::OneOfrulePatch)
    end
  end
end

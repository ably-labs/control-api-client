...
# Unit tests for SwaggerClient::AwsKinesisRuleResponseTarget
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsKinesisRuleResponseTarget' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsKinesisRuleResponseTarget.new
  end
  ...
  describe 'test an instance of AwsKinesisRuleResponseTarget' do
    it 'should create an instance of AwsKinesisRuleResponseTarget' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsKinesisRuleResponseTarget)
    end
  end

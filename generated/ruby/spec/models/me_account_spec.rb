...
# Unit tests for SwaggerClient::MeAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MeAccount' do
  before do
    # run before each test
    @instance = SwaggerClient::MeAccount.new
  end
  ...
  describe 'test an instance of MeAccount' do
    it 'should create an instance of MeAccount' do
      expect(@instance).to be_instance_of(SwaggerClient::MeAccount)
    end
  end

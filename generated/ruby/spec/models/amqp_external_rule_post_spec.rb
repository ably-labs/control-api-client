...
# Unit tests for SwaggerClient::AmqpExternalRulePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmqpExternalRulePost' do
  before do
    # run before each test
    @instance = SwaggerClient::AmqpExternalRulePost.new
  end
  ...
  describe 'test an instance of AmqpExternalRulePost' do
    it 'should create an instance of AmqpExternalRulePost' do
      expect(@instance).to be_instance_of(SwaggerClient::AmqpExternalRulePost)
    end
  end

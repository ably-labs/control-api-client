...
# Unit tests for SwaggerClient::HttpRuleResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'HttpRuleResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::HttpRuleResponse.new
  end
  ...
  describe 'test an instance of HttpRuleResponse' do
    it 'should create an instance of HttpRuleResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::HttpRuleResponse)
    end
  end

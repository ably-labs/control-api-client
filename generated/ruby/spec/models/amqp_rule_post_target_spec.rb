...
# Unit tests for SwaggerClient::AmqpRulePostTarget
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmqpRulePostTarget' do
  before do
    # run before each test
    @instance = SwaggerClient::AmqpRulePostTarget.new
  end
  ...
  describe 'test an instance of AmqpRulePostTarget' do
    it 'should create an instance of AmqpRulePostTarget' do
      expect(@instance).to be_instance_of(SwaggerClient::AmqpRulePostTarget)
    end
  end

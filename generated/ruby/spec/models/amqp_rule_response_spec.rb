...
# Unit tests for SwaggerClient::AmqpRuleResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmqpRuleResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::AmqpRuleResponse.new
  end
  ...
  describe 'test an instance of AmqpRuleResponse' do
    it 'should create an instance of AmqpRuleResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::AmqpRuleResponse)
    end
  end
  ...
  describe 'test attribute "rule_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["amqp"])

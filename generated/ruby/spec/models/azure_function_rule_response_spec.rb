...
# Unit tests for SwaggerClient::AzureFunctionRuleResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AzureFunctionRuleResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::AzureFunctionRuleResponse.new
  end
  ...
  describe 'test an instance of AzureFunctionRuleResponse' do
    it 'should create an instance of AzureFunctionRuleResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::AzureFunctionRuleResponse)
    end
  end

...
# Unit tests for SwaggerClient::KeyPost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'KeyPost' do
  before do
    # run before each test
    @instance = SwaggerClient::KeyPost.new
  end
  ...
  describe 'test an instance of KeyPost' do
    it 'should create an instance of KeyPost' do
      expect(@instance).to be_instance_of(SwaggerClient::KeyPost)
    end
  end

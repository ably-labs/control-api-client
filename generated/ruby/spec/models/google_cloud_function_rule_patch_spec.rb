...
# Unit tests for SwaggerClient::GoogleCloudFunctionRulePatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GoogleCloudFunctionRulePatch' do
  before do
    # run before each test
    @instance = SwaggerClient::GoogleCloudFunctionRulePatch.new
  end
  ...
  describe 'test an instance of GoogleCloudFunctionRulePatch' do
    it 'should create an instance of GoogleCloudFunctionRulePatch' do
      expect(@instance).to be_instance_of(SwaggerClient::GoogleCloudFunctionRulePatch)
    end
  end

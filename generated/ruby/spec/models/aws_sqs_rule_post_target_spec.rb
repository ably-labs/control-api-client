...
# Unit tests for SwaggerClient::AwsSqsRulePostTarget
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsSqsRulePostTarget' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsSqsRulePostTarget.new
  end
  ...
  describe 'test an instance of AwsSqsRulePostTarget' do
    it 'should create an instance of AwsSqsRulePostTarget' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsSqsRulePostTarget)
    end
  end

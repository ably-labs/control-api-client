...
# Unit tests for SwaggerClient::AwsLambdaRuleResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsLambdaRuleResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsLambdaRuleResponse.new
  end
  ...
  describe 'test an instance of AwsLambdaRuleResponse' do
    it 'should create an instance of AwsLambdaRuleResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsLambdaRuleResponse)
    end
  end
  ...
  describe 'test attribute "rule_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["aws/lambda"])

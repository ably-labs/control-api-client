...
# Unit tests for SwaggerClient::IftttRulePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IftttRulePost' do
  before do
    # run before each test
    @instance = SwaggerClient::IftttRulePost.new
  end
  ...
  describe 'test an instance of IftttRulePost' do
    it 'should create an instance of IftttRulePost' do
      expect(@instance).to be_instance_of(SwaggerClient::IftttRulePost)
    end
  end

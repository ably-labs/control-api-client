...
# Unit tests for SwaggerClient::AmqpRulePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AmqpRulePost' do
  before do
    # run before each test
    @instance = SwaggerClient::AmqpRulePost.new
  end
  ...
  describe 'test an instance of AmqpRulePost' do
    it 'should create an instance of AmqpRulePost' do
      expect(@instance).to be_instance_of(SwaggerClient::AmqpRulePost)
    end
  end

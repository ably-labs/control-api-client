...
# Unit tests for SwaggerClient::GoogleCloudFunctionRulePost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GoogleCloudFunctionRulePost' do
  before do
    # run before each test
    @instance = SwaggerClient::GoogleCloudFunctionRulePost.new
  end
  ...
  describe 'test an instance of GoogleCloudFunctionRulePost' do
    it 'should create an instance of GoogleCloudFunctionRulePost' do
      expect(@instance).to be_instance_of(SwaggerClient::GoogleCloudFunctionRulePost)
    end
  end

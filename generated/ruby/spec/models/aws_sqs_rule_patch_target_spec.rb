...
# Unit tests for SwaggerClient::AwsSqsRulePatchTarget
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AwsSqsRulePatchTarget' do
  before do
    # run before each test
    @instance = SwaggerClient::AwsSqsRulePatchTarget.new
  end
  ...
  describe 'test an instance of AwsSqsRulePatchTarget' do
    it 'should create an instance of AwsSqsRulePatchTarget' do
      expect(@instance).to be_instance_of(SwaggerClient::AwsSqsRulePatchTarget)
    end
  end

...
# Unit tests for SwaggerClient::CloudflareWorkerRuleResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CloudflareWorkerRuleResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::CloudflareWorkerRuleResponse.new
  end
  ...
  describe 'test an instance of CloudflareWorkerRuleResponse' do
    it 'should create an instance of CloudflareWorkerRuleResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::CloudflareWorkerRuleResponse)
    end
  end
